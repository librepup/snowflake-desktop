...
myKeys t xp conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm, xK_Tab), submapDefault (arbitraryPrompt promptActionList) $ M.fromList [
        ...
        , ((controlMask .|. shiftMask, xK_f), sendMessage $ Toggle NBFULL)
        ...
        , ((0, xK_n), spawn "kate")
        , ((shiftMask, xK_n), spawn "gnome-text-editor")
        , ((controlMask, xK_n), spawn "nixmacs-client -c")
        , ((shiftMask .|. controlMask, xK_n), spawn "nixmacs -Q --eval \"(load-theme 'modus-vivendi)\"")
        , ((0, xK_a), spawn "pavucontrol")
        , ((shiftMask, xK_a), spawn "pwvucontrol")
