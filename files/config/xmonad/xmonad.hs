...
-- Modules
------------------------------------------------------------------------
import Definitions   -- Set Variables and Functions
import Keybinds      -- Define Keybinds
import Layouts       -- Define Layouts
import AutoStart     -- Set AutoStart Commands
import Log           -- Configure Logging
import WindowRules   -- Define WindowRules
import UserAdditions -- Import Optional User Settings
import MetaHook      -- XMonad "main" Hook
